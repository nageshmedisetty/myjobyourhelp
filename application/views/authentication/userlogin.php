			...
			<div class="content">
				<div class="container-fluid">
                    ...
                    <?php
                        ...
                        echo form_open_multipart("login/checklogin", $attrib)
                    ?> 
											<div class="form-group form-focus">
												<input type="text" class="form-control floating" name="username" id="username" required>
											...
											<div class="text-right">
												<a class="forgot-link" href="<?=base_url('welcome/forgotUserId')?>">Forgot User ID ?</a><br>
												<a class="forgot-link" href="<?=base_url('welcome/forgotPassword')?>">Forgot Password ?</a>
											</div>
                      <div class="col-sm-12">
